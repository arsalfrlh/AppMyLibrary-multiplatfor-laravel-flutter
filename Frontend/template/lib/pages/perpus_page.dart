...
class PerpusPage extends StatefulWidget {
  ...
  @override
  _PerpusPageState createState() => _PerpusPageState();
}

class _PerpusPageState extends State<PerpusPage> {
      ...
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: [
              SpecialOfferCard(
                image: "https://tse4.mm.bing.net/th?id=OIP.jYesRt1a0PgrBMD1GQbFmgHaEw&pid=Api&P=0&h=180",
                category: "Pendidikan",
                numOfBrands: 18,
                press: () {},
              ),
              SpecialOfferCard(
                image: "https://tse4.mm.bing.net/th?id=OIP.yH7Wzz2sTpseN4499k0yMAHaEK&pid=Api&P=0&h=180",
...
class PopularProducts extends StatelessWidget {
  PopularProducts({required this.bukuList});
  List<Buku> bukuList;
          ...
          children: [
            AspectRatio(
              ...
              child: Container(
                ...
                child: CachedNetworkImage(imageUrl: 'http://10.0.2.2:8000/images/${buku.gambar}', fit: BoxFit.cover, errorWidget:(context, url, error) => Icon(Icons.broken_image),),
              ),
            ),
