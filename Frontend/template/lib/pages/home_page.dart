...
class _HomePageState extends State<HomePage> {
  ...
  void _logout() async {
    await apiService.logout().then((_) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Anda telah logout'), backgroundColor: Colors.green));
    });
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const Spacer(flex: 2),
                    ErrorInfo(
                      title: "Hallo dan Selamat datang ${_user!.name}",
                      description:
                          "ini adalah aplikasi perpustakaan online yahh, selamat membaca ^^",
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: Text(btnText ?? "Mulai Membaca".toUpperCase()),
            ),
            const SizedBox(height: 16),
          ],
        ),
